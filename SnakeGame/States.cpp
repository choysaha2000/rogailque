...
void UI::Update(float deltaTime, Game &game, sf::RenderWindow &window) {
  ...
  case GameState::LeaderBoard:
    UpdateLeaderBoardState(game, deltaTime);
    break;
  case GameState::GameOver:
    UpdateGameOverState(game, deltaTime);
    break;
  case GameState::Win:
    UpdateWinState(game, deltaTime);
    break;
  }
}
...
void UI::Init(Game &game) {
  ...
  Save.setPosition((SETTINGS.SCREEN_WIDTH - menuText.getGlobalBounds().width) /
                       2.f,
  ...
  Load.setPosition((SETTINGS.SCREEN_WIDTH - menuText.getGlobalBounds().width) /
                       2.f,
                   SETTINGS.SETTINGS.SCREEN_HEIGHT / 2.f - 100.f);
...
std::string
UI::GetLeaderboardString(const std::unordered_map<std::string, int> &records) {
  ...
  int position = 1;
  for (auto it = sortedRecords.rbegin();
       it != sortedRecords.rend() && position <= 5; ++it, ++position) {
    int score = it->first;
...
void UI::PauseState(Game &game) {
  ...
  PauseMenuPlay.setPosition(
      ...
      SETTINGS.SETTINGS.SCREEN_HEIGHT - PauseMenuPlay.getGlobalBounds().height -
  ...
  PauseMenuMenu.setPosition(
      ...
      PauseMenuPlay.getPosition().y - PauseMenuMenu.getGlobalBounds().height -
          SETTINGS.spacing);
...
void UI::CinState(Game &game) {
  ...
  auto setTextParameters = [this](sf::Text &itemText, const std::string &title,
                                  int fontSize,
  ...
  YES.setPosition((SETTINGS.SCREEN_WIDTH - YES.getGlobalBounds().width) / 2.f,
                  SETTINGS.SETTINGS.SCREEN_HEIGHT / 2.f);
  NO.setPosition((SETTINGS.SCREEN_WIDTH - NO.getGlobalBounds().width) / 2.f,
                 SETTINGS.SETTINGS.SCREEN_HEIGHT / 2.f + 50.f);
...
void UI::OptionsState(Game &game) {
  ...
  tSound.setPosition((SETTINGS.SCREEN_WIDTH - tSound.getGlobalBounds().width) /
                         2.f,
                     SETTINGS.SETTINGS.SCREEN_HEIGHT / 2.f);
  tMusic.setPosition((SETTINGS.SCREEN_WIDTH - tMusic.getGlobalBounds().width) /
                         2.f,
                     SETTINGS.SETTINGS.SCREEN_HEIGHT / 2.f + 50.f);
  tBack.setPosition((SETTINGS.SCREEN_WIDTH - tBack.getGlobalBounds().width) /
                        2.f,
                    SETTINGS.SETTINGS.SCREEN_HEIGHT / 2.f + 100.f);
...
void UI::StartMenuState() {
  ...
  tStart.setPosition((SETTINGS.SCREEN_WIDTH - tStart.getGlobalBounds().width) /
                         2.f,
                     SETTINGS.SETTINGS.SCREEN_HEIGHT / 2.f);
  tDiff.setPosition((SETTINGS.SCREEN_WIDTH - tDiff.getGlobalBounds().width) /
                        2.f,
                    SETTINGS.SETTINGS.SCREEN_HEIGHT / 2.f + 50.f);
  tOptions.setPosition(
      (SETTINGS.SCREEN_WIDTH - tOptions.getGlobalBounds().width) / 2.f,
      SETTINGS.SETTINGS.SCREEN_HEIGHT / 2.f + 100.f);
  tLeader.setPosition(
      (SETTINGS.SCREEN_WIDTH - tLeader.getGlobalBounds().width) / 2.f,
      SETTINGS.SETTINGS.SCREEN_HEIGHT / 2.f + 150.f);
  tExit.setPosition((SETTINGS.SCREEN_WIDTH - tExit.getGlobalBounds().width) /
                        2.f,
                    SETTINGS.SETTINGS.SCREEN_HEIGHT / 2.f + 200.f);
...
void UI::StartDiffState(Game &game) {
  ...
  auto setTextParameters = [&](sf::Text &itemText, const std::string &title,
                               int fontSize,
                               sf::Color color = sf::Color::Transparent) {
    itemText.setString(title);
    itemText.setFont(font);
  ...
  tEasy.setPosition((SETTINGS.SCREEN_WIDTH - tEasy.getGlobalBounds().width) /
                        2.f,
                    SETTINGS.SCREEN_HEIGHT / 2.f);
  tMiddle.setPosition(
      (SETTINGS.SCREEN_WIDTH - tMiddle.getGlobalBounds().width) / 2.f,
      SETTINGS.SCREEN_HEIGHT / 2.f + 50.f);
  tHard.setPosition((SETTINGS.SCREEN_WIDTH - tHard.getGlobalBounds().width) /
                        2.f,
                    SETTINGS.SCREEN_HEIGHT / 2.f + 100.f);
  tBack.setPosition((SETTINGS.SCREEN_WIDTH - tBack.getGlobalBounds().width) /
                        2.f,
                    SETTINGS.SCREEN_HEIGHT / 2.f + 150.f);
  ...
  if (game.GetgameMode() & (uint32_t)GameSettingBits::EasyMode)
    selectedDiffIndex = 0;
  else if (game.GetgameMode() & (uint32_t)GameSettingBits::MiddleMode)
    selectedDiffIndex = 1;
  else if (game.GetgameMode() & (uint32_t)GameSettingBits::HardMode)
    selectedDiffIndex = 2;
...
void UI::DrawLeaderBoard(sf::RenderWindow &window) { window.draw(BackToMenu); }
...
void UI::GameOVERUI(Game &game) {
  ...
  gameOverText.setPosition(SETTINGS.SCREEN_WIDTH / 2.f,
                           SETTINGS.SCREEN_HEIGHT / 2.f);
}
...
void UI::StartWinState(Game &game) {
  ...
  winText.setOrigin(textRect.left + textRect.width / 2.f,
                    textRect.top + textRect.height / 2.f);
  winText.setPosition(SETTINGS.SCREEN_WIDTH / 2.f,
                      SETTINGS.SCREEN_HEIGHT / 2.f);
}
...
void UI::DrawWin(sf::RenderWindow &window) { window.draw(winText); }
